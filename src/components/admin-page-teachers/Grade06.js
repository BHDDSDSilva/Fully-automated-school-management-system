...
export const Grade06TeachersInformationPage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <div>
        ...
        <Button size="big"
            ...
            to="/Grade-06-teachers-records"
            edge="start"
            aria-label="Grade-06-teachers-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography variant="body1" color="#000000" align="center">
            Teachers time table uploaded of all teachers in grade 06 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/Grade-06-teachers-timetable"
            edge="start"
            aria-label="Grade-06-teachers-timetable"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade06-Teacher-status"
            edge="start"
            aria-label="students-grade06-Teacher-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

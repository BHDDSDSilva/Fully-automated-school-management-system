...
export const Grade10TeachersInformationPage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <div>
        ...
        <Button size="big"
            ...
            to="/Grade-10-teachers-records"
            edge="start"
            aria-label="Grade-10-teachers-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography variant="body1" color="#000000" align="center">
            Teachers time table uploaded of all teachers in grade 10 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/Grade-10-teachers-timetable"
            edge="start"
            aria-label="Grade-10-teachers-timetable"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade10-Teacher-status"
            edge="start"
            aria-label="students-grade10-Teacher-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

...
export const Grade11TeachersInformationPage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <div>
        ...
        <Typography variant="body1" color="#800000" align="center">
            Personal information records of all teachers in grade 11 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/Grade-11-teachers-records"
            edge="start"
            aria-label="Grade-11-teachers-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography variant="body1" color="#000000" align="center">
            Teachers time table uploaded of all teachers in grade 11 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/Grade-11-teachers-timetable"
            edge="start"
            aria-label="Grade-11-teachers-timetable"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade11-Teacher-status"
            edge="start"
            aria-label="students-grade11-Teacher-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

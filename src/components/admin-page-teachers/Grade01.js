...
export const Grade01TeachersInformationPage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <div>
        ...
        <Button size="big"
            ...
            to="/Grade-01-teachers-records"
            edge="start"
            aria-label="Grade-01-teachers-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/Grade-01-teachers-timetable"
            edge="start"
            aria-label="Grade-01-teachers-timetable"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade01-Teacher-status"
            edge="start"
            aria-label="students-grade01-Teacher-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

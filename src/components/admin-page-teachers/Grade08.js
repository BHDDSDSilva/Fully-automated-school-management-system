...
export const Grade08TeachersInformationPage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <div>
        ...
        <Typography variant="body1" color="#800000" align="center">
            Personal information records of all teachers in grade 08 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/Grade-08-teachers-records"
            edge="start"
            aria-label="Grade-08-teachers-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography variant="body1" color="#000000" align="center">
            Teachers time table uploaded of all teachers in grade 08 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/Grade-08-teachers-timetable"
            edge="start"
            aria-label="Grade-08-teachers-timetable"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade08-Teacher-status"
            edge="start"
            aria-label="students-grade08-Teacher-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

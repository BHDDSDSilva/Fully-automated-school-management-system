...
export const Grade02TeachersInformationPage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <div>
        ...
        <Button size="big"
            ...
            to="/Grade-02-teachers-records"
            edge="start"
            aria-label="Grade-02-teachers-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/Grade-02-teachers-timetable"
            edge="start"
            aria-label="Grade-02-teachers-timetable"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade02-Teacher-status"
            edge="start"
            aria-label="students-grade02-Teacher-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

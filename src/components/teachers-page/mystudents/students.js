...
export const TeacherStudentPage = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-students-class01"
                edge="start"
                aria-label="teachers-students-class01"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class02"
                edge="start"
                aria-label="teachers-students-class02"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class03"
                edge="start"
                aria-label="teachers-students-class03"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class04"
                edge="start"
                aria-label="teachers-students-class04"

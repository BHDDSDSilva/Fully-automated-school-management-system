...
export const MyStudentClass04Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-students-class04-sinhala"
                edge="start"
                aria-label="teachers-students-class04-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class04-buddadarmaya"
                edge="start"
                aria-label="teachers-students-class04-buddadarmaya"

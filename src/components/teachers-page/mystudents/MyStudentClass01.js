...
export const MyStudentClass01Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-students-class01-sinhala"
                edge="start"
                aria-label="teachers-students-class01-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class01-buddadarmaya"
                edge="start"
                aria-label="teachers-students-class01-buddadarmaya"

...
export const MyStudentClass03Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-students-class03-sinhala"
                edge="start"
                aria-label="teachers-students-class03-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class03-buddadarmaya"
                edge="start"
                aria-label="teachers-students-class03-buddadarmaya"

...
export const MyStudentClass02Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-students-class02-sinhala"
                edge="start"
                aria-label="teachers-students-class02-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-students-class02-buddadarmaya"
                edge="start"
                aria-label="teachers-students-class02-buddadarmaya"

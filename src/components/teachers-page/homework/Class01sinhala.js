...
export const Class01SinhalaHomeworkPage = () => {
    ...
    return (
      ...
      <div>
        <Button 
                ...
                to="/teachers-home-work-class01-upload-home-work-sinhala"
                edge="start"
                aria-label="teachers-home-work-class01-upload-home-work-sinhala"

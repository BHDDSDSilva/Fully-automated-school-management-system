...
export const Class04Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-classes-class04-sinhala"
                edge="start"
                aria-label="teachers-classes-class04-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-classes-class04-buddadarmaya"
                edge="start"
                aria-label="teachers-classes-class04-buddadarmaya"

...
export const Class01Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-classes-class01-sinhala"
                edge="start"
                aria-label="teachers-classes-class01-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-classes-class01-buddadarmaya"
                edge="start"
                aria-label="teachers-classes-class01-buddadarmaya"

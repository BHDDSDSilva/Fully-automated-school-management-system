...
export const Class03Page = () => {
    ...
    return (
        ...
        <Button 
                ...
                to="/teachers-classes-class03-sinhala"
                edge="start"
                aria-label="teachers-classes-class03-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/teachers-classes-class03-buddadarmaya"
                edge="start"
                aria-label="teachers-classes-class03-buddadarmaya"

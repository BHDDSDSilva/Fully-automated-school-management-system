    ...
    return (
      ...
      <div>
        ...
        <Button size="big"
            ...
            to="/students-grade12-grade12-D-Student-records"
            edge="start"
            aria-label="students-grade12-grade12-D-Student-records"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade12-grade12-D-Student-achievement"
            edge="start"
            aria-label="students-grade12-grade12-D-Student-achievement"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade12-grade12-D-Student-status"
            edge="start"
            aria-label="students-grade12-grade12-D-Student-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

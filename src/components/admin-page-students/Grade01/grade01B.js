...
export const Grade01B = () => {
    return (
      ...
      <div>
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade01-grade01-B-Student-achievement"
            edge="start"
            aria-label="students-grade01-grade01-B-Student-achievement"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade01-grade01-B-Student-status"
            edge="start"
            aria-label="students-grade01-grade01-B-Student-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

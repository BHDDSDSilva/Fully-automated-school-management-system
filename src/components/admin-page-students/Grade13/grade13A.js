...
export const Grade13A = () => {
    return (
      ...
      <div>
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade13-grade13-A-Student-achievement"
            edge="start"
            aria-label="students-grade13-grade13-A-Student-achievement"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/students-grade13-grade13-A-Student-status"
            edge="start"
            aria-label="students-grade13-grade13-A-Student-status"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

...
export const Grade13AttendancePage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <Card 
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/students-attendance-grade13-grade13-A"
                        edge="start"
                        aria-label="students-attendance-grade13-grade13-A"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade13-grade13-B"
                        edge="start"
                        aria-label="students-attendance-grade13-grade13-B"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade13-grade13-C"
                        edge="start"
                        aria-label="students-attendance-grade13-grade13-C"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade13-grade13-D"
                        edge="start"
                        aria-label="students-attendance-grade13-grade13-D"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

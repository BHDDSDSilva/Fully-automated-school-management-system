...
export const Grade06AttendancePage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <Card 
        sx={{   maxWidth: '450',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/students-attendance-grade06-grade06-A"
                        edge="start"
                        aria-label="students-attendance-grade06-grade06-A"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '450',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade06-grade06-B"
                        edge="start"
                        aria-label="students-attendance-grade06-grade06-B"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '450',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade06-grade06-C"
                        edge="start"
                        aria-label="students-attendance-grade06-grade06-C"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

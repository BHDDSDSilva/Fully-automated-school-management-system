...
export const Grade04AttendancePage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <Card 
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/students-attendance-grade04-grade04-A"
                        edge="start"
                        aria-label="students-attendance-grade04-grade04-A"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade04-grade04-B"
                        edge="start"
                        aria-label="students-attendance-grade04-grade04-B"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade04-grade04-C"
                        edge="start"
                        aria-label="students-attendance-grade04-grade04-C"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

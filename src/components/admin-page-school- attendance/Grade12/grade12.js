...
export const Grade12AttendancePage = () => {
    return (
      <>
      <div>
        <Box sx={{ width: '20%', 
      ...
      <Card 
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/students-attendance-grade12-grade12-A"
                        edge="start"
                        aria-label="students-attendance-grade12-grade12-A"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade12-grade12-B"
                        edge="start"
                        aria-label="students-attendance-grade12-grade12-B"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade12-grade12-C"
                        edge="start"
                        aria-label="students-attendance-grade12-grade12-C"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '345',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/students-attendance-grade12-grade12-D"
                        edge="start"
                        aria-label="students-attendance-grade12-grade12-D"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

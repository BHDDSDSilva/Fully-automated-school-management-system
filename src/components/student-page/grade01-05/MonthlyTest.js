...
export const SGrade01MonthlyTestPage = () => {
      ...
      <Card 
        sx={{   maxWidth: '450',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/student-monthly-test-paper"
                        edge="start"
                        aria-label="student-monthly-test-paper"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '450',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/student-monthly-test-marking"
                        edge="start"
                        aria-label="student-monthly-test-marking"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

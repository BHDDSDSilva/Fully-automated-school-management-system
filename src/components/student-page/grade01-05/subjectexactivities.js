...
export const SGrade01SubjectEXCurricularActivitiesPage = () => {
    ...
    return (
      ...
      <div className={`${classes.pageHeader} ${classes.mb2}`}> 
        <Button 
                ...
                to="/student-grade-01-subject-ex-curricular-activities-sinhala"
                edge="start"
                aria-label="student-grade-01-subject-ex-curricular-activities-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-01-subject-ex-curricular-activities-budda-darmaya"
                edge="start"
                aria-label="student-grade-01-subject-ex-curricular-activities-budda-darmaya"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-01-subject-ex-curricular-activities-parisaraya"
                edge="start"
                aria-label="student-grade-01-subject-ex-curricular-activities-parisaraya"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-01-subject-ex-curricular-activities-maths"
                edge="start"
                aria-label="student-grade-01-subject-ex-curricular-activities-maths"

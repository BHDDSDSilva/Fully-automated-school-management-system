...
export const SGrade01SubjectNotePage = () => {
    ...
    return (
      ...
      <div className={`${classes.pageHeader} ${classes.mb2}`}> 
        <Button 
                ...
                to="/student-grade-01-subject-sinhala"
                edge="start"
                aria-label="student-grade-01-subject-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-01-subject-budda-darmaya"
                edge="start"
                aria-label="student-grade-01-subject-budda-darmaya"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-01-subject-parisaraya"
                edge="start"
                aria-label="student-grade-01-subject-parisaraya"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-01-subject-maths"
                edge="start"
                aria-label="student-grade-01-subject-maths"

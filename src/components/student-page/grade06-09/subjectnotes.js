...
export const SGrade06SubjectNotePage = () => {
    ...
    return (
      ...
      <div className={`${classes.pageHeader} ${classes.mb2}`}> 
        <Button 
                ...
                to="/student-grade-06-subject-sinhala"
                edge="start"
                aria-label="student-grade-06-subject-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-budda-darmaya"
                edge="start"
                aria-label="student-grade-06-subject-budda-darmaya"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-science"
                edge="start"
                aria-label="student-grade-06-subject-science"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-maths"
                edge="start"
                aria-label="student-grade-06-subject-maths"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-english"
                edge="start"
                aria-label="student-grade-06-subject-english"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-history"
                edge="start"
                aria-label="student-grade-06-subject-history"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-geography"
                edge="start"
                aria-label="student-grade-06-subject-geography"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-06-subject-citizens"
                edge="start"
                aria-label="student-grade-01-subject-citizens"

...
export const StudentGrade06Page = () => {
      ...
      <Card 
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/grade-06-view-notes"
                        edge="start"
                        aria-label="grade-06-view-notes"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-06-view-term-test"
                        edge="start"
                        aria-label="grade-06-view-term-test"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-06-view-monthly-test"
                        edge="start"
                        aria-label="grade-06-view-momthly-test"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-06-view-assigment"
                        edge="start"
                        aria-label="grade-06-view-assigment"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-06-view-extra-curricular-activities"
                        edge="start"
                        aria-label="grade-06-view-extra-curricular-activities"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

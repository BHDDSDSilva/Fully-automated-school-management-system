...
export const SGrade10SubjectNotePage = () => {
    ...
    return (
      ...
      <div className={`${classes.pageHeader} ${classes.mb2}`}> 
        <Button 
                ...
                to="/student-grade-10-subject-sinhala"
                edge="start"
                aria-label="student-grade-10-subject-sinhala"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-budda-darmaya"
                edge="start"
                aria-label="student-grade-10-subject-budda-darmaya"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-science"
                edge="start"
                aria-label="student-grade-10-subject-science"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-maths"
                edge="start"
                aria-label="student-grade-10-subject-maths"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-english"
                edge="start"
                aria-label="student-grade-10-subject-english"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-history"
                edge="start"
                aria-label="student-grade-10-subject-history"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-geography"
                edge="start"
                aria-label="student-grade-10-subject-geography"
        ...
        <Button 
                ...
                size="big"
                component={RouterLink}
                to="/student-grade-10-subject-citizens"
                edge="start"
                aria-label="student-grade-10-subject-citizens"

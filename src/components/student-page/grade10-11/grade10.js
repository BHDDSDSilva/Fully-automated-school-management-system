...
export const StudentGrade10Page = () => {
      ...
      <Card 
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/grade-10-view-notes"
                        edge="start"
                        aria-label="grade-10-view-notes"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-10-view-term-test"
                        edge="start"
                        aria-label="grade-10-view-term-test"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-10-view-monthly-test"
                        edge="start"
                        aria-label="grade-10-view-momthly-test"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-10-view-assigment"
                        edge="start"
                        aria-label="grade-10-view-assigment"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-10-view-extra-curricular-activities"
                        edge="start"
                        aria-label="grade-10-view-extra-curricular-activities"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/grade-10-view-O/L-examination-related-information "
                        edge="start"
                        aria-label="grade-10-view-O/L-examination-related-information"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}

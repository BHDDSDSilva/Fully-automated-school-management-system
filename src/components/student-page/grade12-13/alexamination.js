      ...
      <Card 
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        ...
                        to="/al-new-suject-information"
                        edge="start"
                        aria-label="al-new-suject-information"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/al-new-suject-apply-application"
                        edge="start"
                        aria-label="al-new-suject-apply-application"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
        ...
        sx={{   maxWidth: '200',
            ...
            <CardContent>
                <Typography variant="h4" gutterBottom align='center'>
                    A/L exam admission application
                </Typography>
            </CardContent>
            <CardActions>
                <Button size="big"
                        component={RouterLink}
                        to="/al-exam-admission-application"
                        edge="start"
                        aria-label="al-exam-admission-application"
                sx={{   
                        color: '#000000',
                        fontweight: 'bold'
                    }}
                >
                    View A/L exam admission application
                </Button>
            </CardActions>
        </Card>  
      </div>

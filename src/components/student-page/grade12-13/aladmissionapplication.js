...
export const SALaddmisionapplicationPage = () => {
      ...
      <div>
        <Card 
          ...
          <TextField
            ...
            style={{ marginBottom: '05px' }}
          />
          <Typography>3.Intial with Name</Typography>
          <TextField 
            variant="standard"
            rows={1}
            ...
            style={{ marginBottom: '05px' }}
          />
          <Typography>4.Date of Birthday</Typography>
          <TextField
            variant="standard"
            rows={1}
            ...
            style={{ marginBottom: '05px' }}
          />
          <Typography>5. ID Number</Typography>
          <TextField
            variant="standard"
            rows={1}
            ...
            style={{ marginBottom: '05px' }}
          />
          <Typography>6.Subject Of Field</Typography>
          <TextField
            variant="standard"
            rows={1}
            ...
            style={{ marginBottom: '05px' }}
          />
          <Typography>7.Subject</Typography>
          <StyledTableContainer component={Paper}>
            ...
            style={{ marginBottom: '05px' }}
            /> 
          <Typography>8.Contact Number (Home/Mobile)</Typography>
          <TextField
            variant="standard"
            rows={1}

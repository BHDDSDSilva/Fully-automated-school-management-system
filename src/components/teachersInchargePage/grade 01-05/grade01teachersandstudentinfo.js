...
export const Grade01TeachersInchageStudentsAndTeachersInformationPage = () => {
    ...
    return (
      ...
      <Typography variant="h4" gutterBottom
          sx={{ 
            ...
            Grade 01 Teachers and Students Information
      </Typography>
      </div>
      <div>
        <Card 
        ...
        <Button size="big"
            ...
            to="/teachers-incharge-grade-01-teachers-information"
            edge="start"
            aria-label="teachers-incharge-grade-01-teachers-information"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/teachers-incharge-grade-01-students-information"
            edge="start"
            aria-label="teachers-incharge-grade-01-students-information"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

...
export const Grade10TeachersInchageStudentsInformationPage = () => {
    ...
    const rows = [
      { id: 1,profilePicture:'1121111111', name: 'John Doe',indexNumber:'5598', emailAddress: 'john.doe@example.com', address:'123,tgg', telePhoneNumber: '022548937',status: 'active' },

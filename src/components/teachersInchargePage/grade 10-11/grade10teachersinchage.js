...
export const Grade10TeachersInchagePage = () => {
    ...
    return (
      ...
      <div>
        ...
        <Typography gutterBottom variant="h4" component="div" color="#000080" align='center'fontweight="bold">
            Grade 10 students and teachers information
        </Typography>
        <Typography variant="body1" color="#800000" align="center">
            Personal information records of all teachers and students in grade 10 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/teachers-incharge-grade-10-students-and-teachers-information"
            edge="start"
            aria-label="teachers-incharge-grade-10-students-and-teachers-information"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography variant="body1" color="#000000" align="center">
            Progress of all students in grade 10 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/teachers-incharge-grade-10-students-progress"
            edge="start"
            aria-label="teachers-incharge-grade-10-students-progress"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography variant="body1" color="#800000" align="center">
            Progress of all teachers in grade 10 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/teachers-incharge-grade-10-teachers-progress"
            edge="start"
            aria-label="teachers-incharge-grade-10-teachers-progress"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

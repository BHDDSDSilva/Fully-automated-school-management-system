...
export const Grade10TeachersInchageStudentsAndTeachersInformationPage = () => {
    ...
    return (
      ...
      <Typography variant="h4" gutterBottom
          sx={{ 
            ...
            Grade 10 Teachers and Students Information
      </Typography>
      </div>
      <div>
        <Card 
        ...
        <Typography gutterBottom variant="h4" component="div" color="#000080" align='center'fontweight="bold">
            Grade 10 Teachers Information
        </Typography>
        <Typography variant="body1" color="#800000" align="center">
            Personal information records of all teachers in grade 10 classes
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/teachers-incharge-grade-10-teachers-information"
            edge="start"
            aria-label="teachers-incharge-grade-10-teachers-information"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Button size="big"
            component={RouterLink}
            to="/teachers-incharge-grade-10-students-information"
            edge="start"
            aria-label="teachers-incharge-grade-10-students-information"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'

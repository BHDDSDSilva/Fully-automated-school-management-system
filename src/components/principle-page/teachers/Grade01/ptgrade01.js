    ...
    return (
      ...
      <div>
        ...
        <Typography variant="body1" color="#800000" align="center">
            Personal information records of all teachers in grade 01 class
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/principle-grade-01-teachers-information"
            edge="start"
            aria-label="principle-grade-01-teachers-information"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
        ...
        <Typography gutterBottom variant="h4" component="div" color="#000080" align='center'fontweight="bold">
            Grade 01 Teachers Progress
        </Typography>
        <Typography variant="body1" color="#000000" align="center">
            Progress of all teachers in grade 01 class
        </Typography>          
        <CardActions>
        <Button size="big"
            component={RouterLink}
            to="/principle-grade-01-teachers-progress"
            edge="start"
            aria-label="principle-grade-01-teachers-progress"
            sx={{   
                    color: '#191970',
                    fontweight: 'bold',
                    bottom: '10%'
